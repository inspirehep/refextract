...
def test_reference_split_ibid():
    ref_line = """[17] See for example: Hagelin J S, Kelley S and Tanaka T 1994 Nucl.
    Phys. B 415 (1994) 293. Moroi T 1996 Phys. Rev. D 53 6565 [Erratum-ibid. D 56 (
    1997) 4424] (Preprint hep-ph/9512396)."""
    res = get_references(ref_line)
    references = res[0]
